...
// console.log(true && true || false && !false) //не и иlи
...
// user1 === user2 ? console.log("Если условие true") :
// console.log("Eсли условие false")
...
// // temp < 0 ? console.log(`Температура воздуха опуститься до ${temp} градусов`) :
